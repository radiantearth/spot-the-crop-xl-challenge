...
sub_prelim_test_lgb_fname = sub_dir + "s2-l4-3pt.csv"
sub_prelim_all_lgb_fname = sub_dir + "s2-l4-3pa.csv"
sub_prelim_test_cat_fname = sub_dir + "s2-c4-3pt.csv"
sub_prelim_all_cat_fname = sub_dir + "s2-c4-3pa.csv"
sub_prelim_test_both_fname = sub_dir + "s2-b4-3pt.csv"
sub_prelim_all_both_fname = sub_dir + "s2-b4-3pa.csv"

sub_dirty_oof_test_lgb_fname = sub_dir + "s2-l4-3dt.csv"
sub_dirty_oof_all_lgb_fname = sub_dir + "s2-l4-3da.csv"
sub_dirty_oof_test_cat_fname = sub_dir + "s2-c4-3dt.csv"
sub_dirty_oof_all_cat_fname = sub_dir + "s2-c4-3da.csv"
sub_dirty_oof_test_both_fname = sub_dir + "s2-b4-3dt.csv"
sub_dirty_oof_all_both_fname = sub_dir + "s2-b4-3da.csv"

sub_final_oof_test_lgb_fname = sub_dir + "s2-l4-3ft.csv"
sub_final_oof_all_lgb_fname = sub_dir + "s2-l4-3fa.csv"
sub_final_oof_test_cat_fname = sub_dir + "s2-c4-3ft.csv"
sub_final_oof_all_cat_fname = sub_dir + "s2-c4-3fa.csv"
sub_final_oof_test_both_fname = sub_dir + "s2-b4-3ft.csv"
sub_final_oof_all_both_fname = sub_dir + "s2-b4-3fa.csv"

sub_double_oof_test_lgb_fname = sub_dir + "s2-l4-3ot.csv"
sub_double_oof_all_lgb_fname = sub_dir + "s2-l4-3oa.csv"
sub_double_oof_test_cat_fname = sub_dir + "s2-c4-3ot.csv"
sub_double_oof_all_cat_fname = sub_dir + "s2-c4-3oa.csv"
sub_double_oof_test_both_fname = sub_dir + "s2-b4-3ot.csv"
sub_double_oof_all_both_fname = sub_dir + "s2-b4-3oa.csv"
...
data_support_fname = work_dir + "s2_support.npy"
overlap_fname = work_dir + "overlap_fields.csv"
neighbours_fname = work_dir + "neighbours.csv"
prelim_feature_matrix_fname = work_dir + "features-s2-4-3p.npy"
final_feature_matrix_fname = work_dir + "features-s2-4-3f.npy"
